...
namespace movie_seat_booking.Migrations
{
    ...
    [Migration("20241128055727_RowGroupsadd")]
    partial class RowGroupsadd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("movie_seat_booking.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("movie_seat_booking.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("movie_seat_booking.Models.Rating", b =>
                {
                    ...
                    b.HasOne("movie_seat_booking.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
